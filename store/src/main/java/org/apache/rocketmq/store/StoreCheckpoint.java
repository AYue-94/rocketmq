...
public class StoreCheckpoint {
    ...
    private volatile long physicMsgTimestamp = 0; // commitlog消息存储时间
    private volatile long logicsMsgTimestamp = 0; // consumequeue存储时间
    private volatile long indexMsgTimestamp = 0; // index存储时间
