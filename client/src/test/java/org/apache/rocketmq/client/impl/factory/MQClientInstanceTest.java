...
public class MQClientInstanceTest {
    ...
    public void testFindBrokerAddressInAdmin() {
        mqClientInstance.updateBrokerAddrTable("testBroker", 16L, "127.0.0.1:8083");
        mqClientInstance.updateBrokerAddrTable("testBroker", 0L, "127.0.0.1:8082");
        FindBrokerResult result = mqClientInstance.findBrokerAddressInAdmin("testBroker");
        assertThat(result.isSlave()).isTrue();
    }
}