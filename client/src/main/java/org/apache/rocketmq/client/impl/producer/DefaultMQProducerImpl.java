...
public class DefaultMQProducerImpl implements MQProducerInner {
    ...
    public void initTransactionEnv() {
        ...
        if (producer.getExecutorService() != null) {
            ...
            this.checkExecutor = new ThreadPoolExecutor(
                producer.getCheckThreadPoolMinSize(), // 1
                producer.getCheckThreadPoolMaxSize(), // 1
                1000 * 60,
                TimeUnit.MILLISECONDS,
    ...
    public void start(final boolean startFactory) throws MQClientException {
        ...
        switch (this.serviceState) {
            case CREATE_JUST:
                ...
                // 配置校验，主要是针对producerGroup
                this.checkConfig();

                // instanceName 设置为 pid
    ...
    private SendResult sendDefaultImpl(
        Message msg,
        final CommunicationMode communicationMode, // sync
        final SendCallback sendCallback, // null
        final long timeout // 3s
    ...
    private SendResult sendKernelImpl(final Message msg,
        ...
        if (brokerAddr != null) {
            ...
            try {
                ...
                // 生成messageId，设置Message.properties.UNIQ_KEY
                if (!(msg instanceof MessageBatch)) {
                    MessageClientIDSetter.setUniqID(msg);
                }

                // 设置instanceId，Message.properties.INSTANCE_ID = namespace
                ...
                // SendMessageHook#sendMessageBefore --- 消息轨迹
                ...
                requestHeader.setTopic(msg.getTopic()); // 目标topic
                requestHeader.setDefaultTopic(this.defaultMQProducer.getCreateTopicKey());
                requestHeader.setDefaultTopicQueueNums(this.defaultMQProducer.getDefaultTopicQueueNums());
                requestHeader.setQueueId(mq.getQueueId()); // queue的id
                ...
                requestHeader.setBatch(msg instanceof MessageBatch); // 是否批消息
                // 消费重试相关
    ...
    public TransactionSendResult sendMessageInTransaction(final Message msg,
        ...
        switch (sendResult.getSendStatus()) {
            case SEND_OK: {
                try {
                    ...
                    // 这个PROPERTY_UNIQ_CLIENT_MESSAGE_ID_KEYIDX对应的就是messageId
        ...
        try {
            // 3. 发送END_TRANSACTION oneway 异常忽略
    ...
    public void endTransaction(
        ...
        final MessageId id; // 包含broker的ip:port和commitlog物理offset
        ...
        requestHeader.setCommitLogOffset(id.getOffset()); // commitlog物理offset
        // 根据本地事务执行情况，设置二阶段提交回滚状态
        switch (localTransactionState) {
            case COMMIT_MESSAGE:
        ...
        requestHeader.setProducerGroup(this.defaultMQProducer.getProducerGroup());
        requestHeader.setTranStateTableOffset(sendResult.getQueueOffset()); // 逻辑offset
